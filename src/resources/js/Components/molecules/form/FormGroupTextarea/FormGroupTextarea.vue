...
import FormTextarea from '@/Components/atom/form/FormTextarea/FormTextarea.vue';
...
import type { FormGroupTextareaProps } from './type';

const props = withDefaults(defineProps<FormGroupTextareaProps>(), {});
