...
const form = useForm({
  corporationName: '', // 法人名
  email: '', // メールアドレス // email_hashも同時に送信する // 暗号化 email_hashはhash化
  password: '', // パスワード
  phone: '', //電話番号
  zipCode: '', // 郵便番号
  prefCode: '', // 都道府県
  city: '', // 市区町村
  invoice: '', // インボイス番号 // 暗号化
  applicantName: '', // 法人申込テーブルにて登録
  applicantNameKana: '', // 法人申込テーブルにて登録
  notes: '',
});
...
const onSubmit = () => {
  ...
  form.post(route(RouteName.AdminCorporationStore), {
    onSuccess: () => {
      console.log('送信成功');
      setIsModal(false);
...
<template>
  ...
  <AdminLayout title="チアペイ管理" text="法人登録" :href="RouteName.AdminCorporation">
    <div class="p-corporation-create">
      <div class="p-corporation-create__form">
        ...
        <FormGroupInput
          ...
          class="p-corporation-create__form-element p-corporation-create__form-password"
        />
        <FormGroupInput
          id="phone"
