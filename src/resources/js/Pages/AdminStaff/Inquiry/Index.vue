...
const onSubmit = () => {
  form.post(route(RouteName.AdminStaffInquiryConfirm));
};
</script>
...
<template>
  ...
  >
    <div class="p-admin-staff-inquiry">
      <FormGroupInput
        id="name"
        label="お名前"
        ...
        :maxlength="255"
        class="p-admin-staff-inquiry__form-element p-admin-staff-inquiry__form-name"
      />
      <FormGroupInput
        id="email"
        label="メールアドレス"
        ...
        :maxlength="255"
        class="p-admin-staff-inquiry__form-element p-admin-staff-inquiry__form-email"
      />
      <FormGroupTextarea
        id="content"
        label="内容"
        ...
        :required-type="FormRequiredLabelTypeProp.Required"
        class="p-admin-staff-inquiry__form-element p-admin-staff-inquiry__form-content"
      />
      ...
      <template v-if="form.errors.consent">
        <p class="p-admin-staff-inquiry__error">{{ form.errors.consent }}</p>
      </template>
      <div class="p-admin-staff-inquiry__button-container">
