...
const onDelete = (): void => {
  ...
  deleteForm.delete(
    route(RouteName.BusinessOperatorStaffTipsDelete, {
...
const onSubmit = (): void => {
  form.post(route(RouteName.BusinessOperatorStaffTipsCreate, { tipId: props.userTip.tipId }), {
    onSuccess: () => {
      form.reset();
...
<template>
  <BaseLayout
    ...
    :auth-header="{
      ...
      href: RouteName.BusinessOperatorStaffTips,
    }"
  >
        ...
        :staff-tip-reply="
          props.staffTipReply
            ? {
                ...
                image: props.staffTipReply.image || '',
