...
const onSubmit = () => {
  form.post(route(RouteName.CorporationInquiryConfirm));
};
</script>
...
<template>
  ...
  >
    <div class="p-corporation-inquiry">
      <FormGroupInput
        id="name"
        label="お名前"
        ...
        :maxlength="255"
        class="p-corporation-inquiry__form-element p-corporation-inquiry__form-name"
      />
      <FormGroupInput
        id="email"
        label="メールアドレス"
        ...
        :maxlength="255"
        class="p-corporation-inquiry__form-element p-corporation-inquiry__form-email"
      />
      <FormGroupTextarea
        id="content"
        label="内容"
        ...
        :required-type="FormRequiredLabelTypeProp.Required"
        class="p-corporation-inquiry__form-element p-corporation-inquiry__form-content"
      />
      ...
      <template v-if="form.errors.consent">
        <p class="p-corporation-inquiry__error">{{ form.errors.consent }}</p>
      </template>
      <div class="p-corporation-inquiry__button-container">
