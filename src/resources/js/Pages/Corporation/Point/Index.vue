...
const props = defineProps<{
  ...
  yearMonthList: yearMonthListProps[];
}>();
</script>
  ...
  >
    ...
    <div class="p-business-operator-point__wrapper">
      <Link
        ...
        :key="index"
        :href="route(RouteName.CorporationPointBusinessOperator, { yearMonth: item.yearMonth })"
