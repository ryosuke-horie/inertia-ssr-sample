...
<template>
  <BaseLayout
    ...
    :auth-header="{
      text: props.yearMonth,
      href: RouteName.CorporationPointBusinessOperator,
      params: { yearMonth: props.yearMonth.replace('年', '-').replace('月', '') },
    }"
  >
    ...
    <div class="p-business-operator-point-staff__wrapper">
      <div class="p-business-operator-point-staff__wrapper__list" v-for="(item, index) in props.staffList" :key="index">
