...
const onSubmit = () => {
  form.post(route(RouteName.StaffInquiryConfirm));
};
</script>
  ...
  >
    <div class="p-staff-inquiry">
      <FormGroupInput
        ...
        :maxlength="255"
        class="p-staff-inquiry__form-element p-staff-inquiry__form-name"
      />
      <FormGroupInput
        id="email"
        label="メールアドレス"
        ...
        :maxlength="255"
        class="p-staff-inquiry__form-element p-staff-inquiry__form-email"
      />
      <FormGroupTextarea
        id="content"
        label="内容"
        ...
        :required-type="FormRequiredLabelTypeProp.Required"
        class="p-staff-inquiry__form-element p-staff-inquiry__form-content"
      />
      ...
      <template v-if="form.errors.consent">
        <p class="p-staff-inquiry__error">{{ form.errors.consent }}</p>
      </template>
      <div class="p-staff-inquiry__button-container">
