...
<template>
  <BaseLayout
    ...
    :auth-header="{
      role: RouteRoleName.User,
      text: '事業者詳細',
      href: RouteName.UserBusinessOperator,
    }"
  >
    ...
    <div class="p-user-business-operator-show">
      ...
      <!-- 所属スタッフ -->
      <SwiperFavoriteStaffList :list="props.staff" :is-guest-user="false" />
      <AnkerButton
      ...
      <!-- 口コミ -->
      <BusinessReview :business-reviews="localReviews" :user-id="props.userId" @on-delete-review="onDeleteReview" />
      <AnkerButton
