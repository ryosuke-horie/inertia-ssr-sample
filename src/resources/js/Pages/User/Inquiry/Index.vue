...
const onSubmit = () => {
  form.post(route(RouteName.UserInquiryConfirm));
};
</script>
  ...
  >
    <div class="p-user-inquiry">
      <FormGroupInput
        ...
        :maxlength="255"
        class="p-user-inquiry__form-element p-user-inquiry__form-name"
      />
      <FormGroupInput
        id="email"
        label="メールアドレス"
        ...
        :maxlength="255"
        class="p-user-inquiry__form-element p-user-inquiry__form-email"
      />
      <FormGroupTextarea
        id="content"
        label="内容"
        ...
        :required-type="FormRequiredLabelTypeProp.Required"
        class="p-user-inquiry__form-element p-user-inquiry__form-content"
      />
      ...
      <template v-if="form.errors.consent">
        <p class="p-user-inquiry__error">{{ form.errors.consent }}</p>
      </template>
      <div class="p-user-inquiry__button-container">
