...
const onSubmit = () => {
  form.post(route(RouteName.InquiryConfirm));
};
</script>
  ...
  >
    <div class="p-inquiry">
      <FormGroupInput
        ...
        :maxlength="255"
        class="p-inquiry__form-element p-inquiry__form-name"
      />
      <FormGroupInput
        id="email"
        label="メールアドレス"
        ...
        :maxlength="255"
        class="p-inquiry__form-element p-inquiry__form-email"
      />
      <FormGroupTextarea
        id="content"
        label="内容"
        ...
        :required-type="FormRequiredLabelTypeProp.Required"
        class="p-inquiry__form-element p-inquiry__form-content"
      />
      ...
      <template v-if="form.errors.consent">
        <p class="p-inquiry__error">{{ form.errors.consent }}</p>
      </template>
      <div class="p-inquiry__button-container">
